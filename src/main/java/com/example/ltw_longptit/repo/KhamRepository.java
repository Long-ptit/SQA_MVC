...
public interface KhamRepository extends JpaRepository<Kham, Integer> {
    ...
    @Query(value = "select * from kham where datein like %:keyword% and id_bs = :id",nativeQuery = true)
    public List<Kham> getAllKhamTheoBacsiTrongThang( String keyword , String id);
