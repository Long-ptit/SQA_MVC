...
@RestController
@RequestMapping(path = "/kham", produces = "application/json")//anh xa http request
@CrossOrigin(origins = "*")
public class KhamController {
    ...
    public Iterable<Kham> getKhamByBacsyTrongThang(@PathVariable("keyword") String keyword , @PathVariable("id") String id) {
       return khamRepository.getAllKhamTheoBacsiTrongThang(keyword, id);
    }
